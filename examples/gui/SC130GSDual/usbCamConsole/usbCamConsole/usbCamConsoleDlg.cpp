...
void  Disp(LPVOID lpParam)
{
	...
	cv::Mat frame_gray1(g_iHeight/2, g_iWidth,CV_8UC1, pDataBuffer);
	cv::Mat frame_gray2(g_iHeight / 2, g_iWidth, CV_8UC1, pDataBuffer+ g_iWidth*g_iHeight / 2);

	cv::imshow("disp", frame_gray1);
	cv::imshow("disp1", frame_gray2);
	cv::waitKey(1);
