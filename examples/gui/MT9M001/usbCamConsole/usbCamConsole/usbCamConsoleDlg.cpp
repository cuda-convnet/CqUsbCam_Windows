...
void CusbCamConsoleDlg::OnBnClickedRadioResolu12801024()
{
	...
	if (m_bIsCamSelected)
	{
		m_sensorInUse->SetResolution(RESOLU_1280_1024);
		g_byteResolutionType = RESOLU_1280_1024;
		g_iWidth = 1280 ;
		g_iHeight = 1024;
	}

	SetDlgItemText(IDC_STATIC_STATUS, L"分辨率1280*720。");
}
